...
An example project implementing [Svelte Material UI](https://github.com/hperrin/svelte-material-ui)
...
As such, this repo might break during SvelteKit's development. If it does, please ping me (@SylphWeed)
in [the SMUI support Discord channel](https://discord.gg/aFzmkrmg9P).
